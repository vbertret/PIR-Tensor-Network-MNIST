...
The goal of the project is to optimize a **Matrix Product State** so that it will be able to classify inputs. For that, there exists differents possibilities. Here, the 2 possibilities developped are : 
